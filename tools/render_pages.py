...
FAQ_CONTENT: dict[str, dict[str, Any]] = {
    ...
    "pt_pt": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "Respostas curtas para utilizadores eMule que querem experimentar o eMuleBB para binding, partilha, slots de upload, Kad, REST e testes de 0.7.3-rc.1.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("Que release do eMule devo usar para testar?", "Use a release do GitHub eMuleBB 0.7.3-rc.1 publicada para os testes RC. O alvo estável continua a ser 0.7.3 depois de passarem os gates.", "Painel de release 0.7.3", FAQ_LINKS["release"]),
    ...
    "tr": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "binding, paylaşım, yükleme yuvaları, Kad, REST ve 0.7.3-rc.1 testleri için eMuleBB'yi denemek isteyen eMule kullanıcılarına kısa yanıtlar.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("Test için hangi eMule sürümünü kullanmalıyım?", "RC testi için yayınlanmış eMuleBB 0.7.3-rc.1 GitHub Release'ini kullanın. Kararlı hedef, geçitler geçildikten sonra 0.7.3 olarak kalır.", "0.7.3 sürüm panosu", FAQ_LINKS["release"]),
    ...
    "ko": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "binding, 공유, 업로드 슬롯, Kad, REST, 0.7.3-rc.1 테스트를 위해 eMuleBB를 사용해 보려는 eMule 사용자를 위한 짧은 답변.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("테스트에는 어떤 eMule 릴리스를 사용해야 하나요?", "RC 테스트에는 공개된 eMuleBB 0.7.3-rc.1 GitHub Release를 사용하세요. 안정 목표는 게이트를 통과한 뒤 0.7.3으로 유지됩니다.", "0.7.3 릴리스 대시보드", FAQ_LINKS["release"]),
    ...
    "ar_ae": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "إجابات قصيرة لمستخدمي eMule الراغبين في تجربة eMuleBB من أجل binding والمشاركة وخانات الرفع وKad وREST واختبارات 0.7.3-rc.1.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("أي إصدار eMule يجب أن أستخدم للاختبار؟", "استخدم إصدار GitHub المنشور eMuleBB 0.7.3-rc.1 لاختبار RC. يبقى الهدف المستقر 0.7.3 بعد اجتياز البوابات.", "لوحة إصدار 0.7.3", FAQ_LINKS["release"]),
