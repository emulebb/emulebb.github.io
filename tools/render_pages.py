...
FAQ_LOCALE_KEYS = ("en", "it", "es", "pt_br", "pt_pt", "fr", "de", "pl", "nl", "ru", "tr", "uk", "ko", "ar_ae", "zh_cn", "ja")
FAQ_PAGE_BY_KEY = {
    page.key: PageSpec(
        page.key,
        page.hreflang,
...
RELEASE_DOWNLOADS = [
    ("https://github.com/emulebb/emulebb/releases/tag/emulebb-v0.7.3-rc.2", "eMuleBB RC2"),
    ("https://github.com/emulebb/emulebb/releases/download/emulebb-v0.7.3-rc.2/emulebb-0.7.3-rc.2-x64.zip", "x64 ZIP"),
    ("https://github.com/emulebb/amutorrent/releases/tag/amutorrent-v3.8.5-emulebb-v0.7.3-rc.2", "aMuTorrent RC2"),
]

INSTALL_CALLOUT = {
    "id": "install",
    "eyebrow": "Download",
    "h2": "Install RC2 with one PowerShell line, or download the ZIP manually.",
    ...
    "standalone": "Standalone app: download the RC2 ZIP, extract it, and run <code>emulebb.exe</code>.",
    "primary": "Open RC2 release",
    "primary_href": "https://github.com/emulebb/emulebb/releases/tag/emulebb-v0.7.3-rc.2",
    "secondary": "Setup details",
    "secondary_href": f"{DOCS_SITE_URL}/reference/GUIDE-SETUP/",
}

TESTING_CALLOUT = {
    "eyebrow": "RC2 published",
    "h2": "0.7.3-rc.2 is open for testers",
    "p": "Try the published RC2 packages, keep a disposable or backed-up profile, and report crashes, freezes, package issues, controller/API problems, and real-network regressions.",
    "primary": "eMuleBB RC2",
    "primary_href": "https://github.com/emulebb/emulebb/releases/tag/emulebb-v0.7.3-rc.2",
...
CONTENT: dict[str, dict[str, Any]] = {
    "en": {
        ...
        "meta_description": "eMuleBB RC2 is published: install eMule broadband edition with a PowerShell suite bootstrapper or standalone ZIP, with GitHub-built package provenance.",
        ...
        "hero": {
            ...
            "lead": "RC2 is published: a serious Windows eMule line for fast upload links, large shared libraries, always-on sessions, REST controller workflows, Arr integration, and GitHub-built package evidence.",
            "install": "Download RC2",
            "source": "Source",
            "guide": "Product guide",
            "panel_kicker": "Product posture",
            "panel_h2": "eMuleBB is the product. The ecosystem is the proof lab.",
            "panel_p": "The desktop app stays stock-compatible where the network matters. The RC2 suite adds local controller workflows around it without turning eMuleBB into a generic torrent shell.",
            "signals": ["0.7.3-rc.2 published", "One-line suite bootstrap", "Manual standalone ZIP", "GitHub Actions builds", "Manifest hash verification", "SPDX SBOMs", "aMuTorrent controller", "Prowlarr Torznab", "Radarr/Sonarr qBit adapter", "Stock eD2K/Kad compatibility"],
        },
        "intro": "This is the home of <strong>eMuleBB</strong>: <strong>eMule broadband edition</strong>, an independent product for people who still value eMule's distributed sharing model and want it operated like modern software. RC2 packages are published on GitHub Releases with a full-suite bootstrapper, standalone ZIPs, manifests, hashes, SBOMs, and matching aMuTorrent controller assets.",
        "why": {
        ...
        "features": {
            **s("Features", "What eMuleBB adds around the classic client", "The RC2 work is focused on operator-visible behavior: predictable upload policy, safer binding, fixed performance limits, large-library operation, local automation, and package evidence."),
            "cards": [
                ...
                c("Testing and release discipline", "Evidence before labels", "<code>0.7.3-rc.2</code> is published with GitHub Actions packaging, manifests, SHA-256 evidence, SPDX SBOMs, diagnostics assets, and bootstrapper hash evidence."),
            ],
        },
        "guide": {
        ...
        "release": {
            **s("Security and provenance", "RC2 is built and packaged on GitHub"),
            "cards": [
                c("", "Published RC2", "<code>emulebb-v0.7.3-rc.2</code> is a GitHub prerelease with x64 and ARM64 ZIPs, diagnostics packages, manifests, SBOMs, and the suite bootstrapper."),
                ...
                c("", "Suite assets", "The matching aMuTorrent RC2 package is published separately, and the full x64 bootstrap flow resolves it automatically for controller setup."),
...
FAQ_CONTENT: dict[str, dict[str, Any]] = {
    "en": {
        ...
        "meta_description": "Short answers for eMule users who want to try eMuleBB for binding, sharing, upload slots, Kad, REST, and 0.7.3-rc.2 testing.",
        ...
        "items": [
            ...
            faq_item("Which eMule release should I use for testing?", "Use the published eMuleBB 0.7.3-rc.2 GitHub Release for RC testing. The stable target remains 0.7.3 after the release gates pass.", "0.7.3 release dashboard", FAQ_LINKS["release"]),
    ...
    "it": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "Risposte brevi per utenti eMule che vogliono provare eMuleBB per binding, condivisione, slot di upload, Kad, REST e test 0.7.3-rc.2.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("Quale release di eMule dovrei usare per i test?", "Usa la release GitHub eMuleBB 0.7.3-rc.2 pubblicata per i test RC. Il target stabile resta 0.7.3 dopo il passaggio dei gate.", "Dashboard release 0.7.3", FAQ_LINKS["release"]),
    ...
    "es": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "Respuestas breves para usuarios de eMule que quieren probar eMuleBB con binding, biblioteca compartida, slots de subida, Kad, REST y 0.7.3-rc.2.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("Que release de eMule debo usar para pruebas?", "Usa la release GitHub eMuleBB 0.7.3-rc.2 publicada para pruebas RC. El objetivo estable sigue siendo 0.7.3 despues de pasar los gates.", "Panel de release 0.7.3", FAQ_LINKS["release"]),
    ...
    "pt_br": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "Respostas curtas para usuarios do eMule que querem testar o eMuleBB com binding, compartilhamento, slots de upload, Kad, REST e 0.7.3-rc.2.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("Qual release do eMule devo usar para testes?", "Use a release GitHub eMuleBB 0.7.3-rc.2 publicada para testes RC. O alvo estavel continua sendo 0.7.3 depois que os gates passarem.", "Painel da release 0.7.3", FAQ_LINKS["release"]),
    ...
    "fr": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "Reponses courtes pour les utilisateurs eMule qui veulent essayer eMuleBB: binding, partage, slots d'upload, Kad, REST et 0.7.3-rc.2.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("Quelle release eMule utiliser pour tester?", "Utilisez la release GitHub eMuleBB 0.7.3-rc.2 publiee pour les tests RC. La cible stable reste 0.7.3 apres le passage des gates.", "Tableau release 0.7.3", FAQ_LINKS["release"]),
    ...
    "de": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "Kurze Antworten fuer eMule-Nutzer, die eMuleBB fuer Binding, Shares, Upload-Slots, Kad, REST und 0.7.3-rc.2 testen wollen.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("Welche eMule-Release soll ich testen?", "Nutze die veroeffentlichte eMuleBB 0.7.3-rc.2 GitHub Release fuer RC-Tests. Das stabile Ziel bleibt 0.7.3 nach bestandenen Gates.", "0.7.3 release dashboard", FAQ_LINKS["release"]),
    ...
    "pl": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "Krotkie odpowiedzi dla uzytkownikow eMule, ktorzy chca wyprobowac eMuleBB: binding, udostepnianie, sloty uploadu, Kad, REST i 0.7.3-rc.2.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("Ktore wydanie eMule wybrac do testow?", "Do testow RC uzywaj opublikowanej GitHub release eMuleBB 0.7.3-rc.2. Stabilnym celem pozostaje 0.7.3 po przejsciu gate'ow.", "Panel wydania 0.7.3", FAQ_LINKS["release"]),
    ...
    "nl": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "Korte antwoorden voor eMule-gebruikers die eMuleBB willen proberen voor binding, delen, uploadslots, Kad, REST en 0.7.3-rc.2.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("Welke eMule-release moet ik testen?", "Gebruik de gepubliceerde eMuleBB 0.7.3-rc.2 GitHub Release voor RC-tests. Het stabiele doel blijft 0.7.3 nadat de gates slagen.", "0.7.3 release dashboard", FAQ_LINKS["release"]),
    ...
    "ru": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "Короткие ответы для пользователей eMule, которые хотят попробовать eMuleBB: binding, общие папки, upload slots, Kad, REST и 0.7.3-rc.2.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("Какой релиз eMule использовать для тестов?", "Для RC-тестирования используйте опубликованный GitHub Release eMuleBB 0.7.3-rc.2. Стабильная цель остается 0.7.3 после прохождения gate.", "0.7.3 release dashboard", FAQ_LINKS["release"]),
    ...
    "uk": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "Короткі відповіді для користувачів eMule, які хочуть спробувати eMuleBB: binding, спільні бібліотеки, upload slots, Kad, REST і 0.7.3-rc.2.",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("Який реліз eMule використовувати для тестів?", "Для RC-тестування використовуйте опублікований GitHub Release eMuleBB 0.7.3-rc.2. Стабільна ціль лишається 0.7.3 після проходження gate.", "0.7.3 release dashboard", FAQ_LINKS["release"]),
    ...
    "zh_cn": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "面向 eMule 用户的简短问答：用 eMuleBB 处理绑定、共享库、上传槽、Kad、REST 和 0.7.3-rc.2 测试。",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("测试时应该使用哪个 eMule 版本?", "RC 测试请使用已发布的 eMuleBB 0.7.3-rc.2 GitHub Release。通过 release gates 后，稳定目标仍是 0.7.3。", "0.7.3 发布面板", FAQ_LINKS["release"]),
    ...
    "ja": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "eMule ユーザー向けの短いFAQ。eMuleBB の binding、共有ライブラリ、upload slots、Kad、REST、0.7.3-rc.2 テストを扱います。",
        "og_title": "FAQ | eMule broadband edition",
        ...
        "items": [
            ...
            faq_item("テストにはどの eMule release を使えばよいですか?", "RC テストには公開済みの eMuleBB 0.7.3-rc.2 GitHub Release を使ってください。安定版の目標は gates 通過後の 0.7.3 です。", "0.7.3 リリースダッシュボード", FAQ_LINKS["release"]),
    ...
    "pt_pt": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "Respostas curtas para utilizadores eMule que querem experimentar o eMuleBB para binding, partilha, slots de upload, Kad, REST e testes de 0.7.3-rc.2.",
        "og_title": "FAQ | eMule broadband edition",
        "og_description": "Respostas rápidas do eMuleBB para utilizadores eMule.",
        "nav_label": "Navegação das FAQ",
        "eyebrow": "FAQ",
        "h1": "Perguntas comuns sobre eMule, respondidas para o eMuleBB",
        "lead": "Respostas curtas para quem quer o fluxo clássico do eMule com melhor controlo de banda larga, rede mais segura e provas de release mais claras.",
        "home_label": "Início",
        "docs_label": "Documentação",
        "faq_label": "FAQ",
        "github_label": "GitHub",
        "languages_label": "Idiomas",
        "read_more": "Saber mais",
        "items": [
            faq_item("Como ligo o eMule a uma interface ou VPN?", "O eMuleBB pode vincular o tráfego P2P a uma interface ou endereço local e bloquear o arranque se o destino faltar. Mantenha o kill switch da VPN, a firewall e o bind do WebServer/REST separados.", "Guia de rede", FAQ_LINKS["network"]),
            ...
            faq_item("Que release do eMule devo usar para testar?", "Use a release do GitHub eMuleBB 0.7.3-rc.2 publicada para os testes RC. O alvo estável continua a ser 0.7.3 depois de passarem os gates.", "Painel de release 0.7.3", FAQ_LINKS["release"]),
            ...
            faq_item("Posso automatizar o eMule com ferramentas externas?", "Sim. O eMuleBB expõe uma REST API JSON autenticada para controladores locais de confiança, mantendo a semântica nativa de transferências e partilha na aplicação de ambiente de trabalho.", "Guia de controladores e REST", FAQ_LINKS["controllers"]),
        ],
    },
    "tr": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "binding, paylaşım, yükleme yuvaları, Kad, REST ve 0.7.3-rc.2 testleri için eMuleBB'yi denemek isteyen eMule kullanıcılarına kısa yanıtlar.",
        "og_title": "FAQ | eMule broadband edition",
        "og_description": "eMule kullanıcıları için hızlı eMuleBB yanıtları.",
        "nav_label": "SSS gezinmesi",
        "eyebrow": "SSS",
        "h1": "eMuleBB için yanıtlanan yaygın eMule soruları",
        "lead": "Klasik eMule iş akışını daha iyi geniş bant denetimi, daha güvenli ağ ve daha net sürüm kanıtıyla isteyen kullanıcılara kısa yanıtlar.",
        ...
        "items": [
            faq_item("eMule'yi bir arabirime veya VPN'e nasıl bind ederim?", "eMuleBB, P2P trafiğini adlandırılmış bir arabirime veya yerel adrese bind edebilir ve hedef yoksa başlatmayı engelleyebilir. VPN kill switch'inizi, güvenlik duvarınızı ve WebServer/REST bind politikanızı ayrı tutun.", "Ağ kılavuzu", FAQ_LINKS["network"]),
            ...
            faq_item("Test için hangi eMule sürümünü kullanmalıyım?", "RC testi için yayınlanmış eMuleBB 0.7.3-rc.2 GitHub Release'ini kullanın. Kararlı hedef, geçitler geçildikten sonra 0.7.3 olarak kalır.", "0.7.3 sürüm panosu", FAQ_LINKS["release"]),
            ...
            faq_item("eMule'yi harici araçlarla otomatikleştirebilir miyim?", "Evet. eMuleBB, güvenilir yerel denetleyiciler için kimliği doğrulanmış bir JSON REST API sunarken aktarım ve paylaşımın yerel semantiğini masaüstü uygulamasında tutar.", "Denetleyiciler ve REST kılavuzu", FAQ_LINKS["controllers"]),
        ],
    },
    "ko": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "binding, 공유, 업로드 슬롯, Kad, REST, 0.7.3-rc.2 테스트를 위해 eMuleBB를 사용해 보려는 eMule 사용자를 위한 짧은 답변.",
        "og_title": "FAQ | eMule broadband edition",
        "og_description": "eMule 사용자를 위한 빠른 eMuleBB 답변.",
        "nav_label": "FAQ 내비게이션",
        "eyebrow": "FAQ",
        "h1": "eMuleBB를 위해 답한 일반적인 eMule 질문",
        "lead": "더 나은 광대역 제어, 더 안전한 네트워킹, 더 명확한 릴리스 증거와 함께 클래식한 eMule 워크플로를 원하는 사용자를 위한 짧은 답변.",
        "home_label": "홈",
        "docs_label": "문서",
        "faq_label": "FAQ",
        "github_label": "GitHub",
        ...
        "read_more": "더 읽기",
        "items": [
            faq_item("eMule을 인터페이스나 VPN에 어떻게 bind하나요?", "eMuleBB는 P2P 트래픽을 지정된 인터페이스나 로컬 주소에 bind할 수 있고, 대상이 없으면 시작을 막을 수 있습니다. VPN 킬 스위치, 방화벽, WebServer/REST bind 정책은 따로 유지하세요.", "네트워크 가이드", FAQ_LINKS["network"]),
            ...
            faq_item("테스트에는 어떤 eMule 릴리스를 사용해야 하나요?", "RC 테스트에는 공개된 eMuleBB 0.7.3-rc.2 GitHub Release를 사용하세요. 안정 목표는 게이트를 통과한 뒤 0.7.3으로 유지됩니다.", "0.7.3 릴리스 대시보드", FAQ_LINKS["release"]),
            ...
            faq_item("외부 도구로 eMule을 자동화할 수 있나요?", "네. eMuleBB는 신뢰된 로컬 컨트롤러를 위한 인증된 JSON REST API를 제공하면서 전송과 공유의 네이티브 시맨틱을 데스크톱 앱에 유지합니다.", "컨트롤러 및 REST 가이드", FAQ_LINKS["controllers"]),
        ],
    },
    "ar_ae": {
        "title": "FAQ | eMule broadband edition",
        "meta_description": "إجابات قصيرة لمستخدمي eMule الراغبين في تجربة eMuleBB من أجل binding والمشاركة وخانات الرفع وKad وREST واختبارات 0.7.3-rc.2.",
        "og_title": "FAQ | eMule broadband edition",
        "og_description": "إجابات eMuleBB سريعة لمستخدمي eMule.",
        "nav_label": "تنقل الأسئلة الشائعة",
        "eyebrow": "الأسئلة الشائعة",
        "h1": "أسئلة eMule الشائعة، مُجابة لأجل eMuleBB",
        "lead": "إجابات قصيرة لمن يريد سير عمل eMule الكلاسيكي مع تحكم أفضل في النطاق العريض وشبكة أكثر أمانًا وأدلة إصدار أوضح.",
        "home_label": "الرئيسية",
        "docs_label": "الوثائق",
        ...
        "items": [
            faq_item("كيف أربط eMule بواجهة أو VPN؟", "يستطيع eMuleBB ربط حركة P2P بواجهة مُسمّاة أو عنوان محلي، ويمكنه منع بدء التشغيل عند غياب الهدف. أبقِ مفتاح إيقاف VPN وجدار الحماية وسياسة ربط WebServer/REST منفصلة.", "دليل الشبكة", FAQ_LINKS["network"]),
            ...
            faq_item("أي إصدار eMule يجب أن أستخدم للاختبار؟", "استخدم إصدار GitHub المنشور eMuleBB 0.7.3-rc.2 لاختبار RC. يبقى الهدف المستقر 0.7.3 بعد اجتياز البوابات.", "لوحة إصدار 0.7.3", FAQ_LINKS["release"]),
            ...
            faq_item("هل يمكنني أتمتة eMule بأدوات خارجية؟", "نعم. يعرض eMuleBB واجهة JSON REST API مصادَقًا عليها للمتحكمات المحلية الموثوقة مع إبقاء دلالات النقل والمشاركة الأصلية في تطبيق سطح المكتب.", "دليل المتحكمات وREST", FAQ_LINKS["controllers"]),
        ],
    },
}
...
def make_stock_locale_content(t: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "hero": {
            ...
            "panel_h2": t["method"],
            "panel_p": t["intro"],
            "signals": ["eD2K/Kad", "Upload", "Testing", "RC2", "Performance", "REST API", "0.7.3-rc.2"],
        },
        "intro": t["intro"],
        ...
        "guide": {**s(t["nav"][2], t["guide"]), "cards": [c("", t["keep"], t["intro"]), c("", t["control"], t["lead"]), c("", "Testing", t["proof"]), c("", "RC2 published", t["release"]), c("", "0.7.3-rc.2", t["release"]), c("", t["product_guide"], t["docs"])]},
        ...
        "release": {**s(t["nav"][5], t["release"]), "cards": [c("", "0.7.3-rc.2", t["release"]), c("", "Fast CI", t["proof"]), c("", t["proof"], t["proof"]), c("", "Performance", t["lead"]), c("", "eD2K/Kad", t["keep"]), c("", "Status", t["release"])]},
...
def add_release_evidence_copy(content: dict[str, Any]) -> None:
    ...
    if not any("RC2" in signal for signal in signals):
        signals.append("RC2 on GitHub Releases")
...
def with_generated_links(root: Path) -> None:
    ...
    for page in PAGES:
        ...
        content["hero"]["install"] = "Download RC2" if page.key == "en" else content["hero"].get("install", "Install")
