...
DOCS = [
    ...
    (f"{DOCS_SITE_URL}/reference/GUIDE-TOOLS-MENU/", "tools_menu"),
        ...
        "guide": {
            **s("Product guide", "A short operating model"),
            "cards": [
                ...
                c("", "Automate only on trusted networks", "Enable WebServer/REST with an API key, bind and firewall it carefully, keep unsafe diagnostic REST disabled outside controlled support runs, and use controllers that respect native eMule transfer and delete semantics."),
